                ...
                <div class="achivements-cont">
                    <div class="achive-left">
                        ...
                        <div class="achive-cards">
                            ...
                            <a href="admin-panel-student-courses.php">
                                <article class="achive-box">
                                    <span class="achive-icon"><i class="uil uil-book-open"></i></span>
                                    <h3>Student Courses</h3>
                                </article>
                            </a>

                            <a href="admin-panel-faculty-courses.php">
                                <article class="achive-box">
                                    <span class="achive-icon"><i class="uil uil-presentation-check"></i></span>
