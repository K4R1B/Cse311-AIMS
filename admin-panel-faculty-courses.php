            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>List of Assigned Faculty & Courses
                        </h4><br>
                        <a href="faculty-data-course-register.php" class="btn btn-success btn-sm">Add faculty To
                            Course</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="faculty-course-register.php?id=<?= $dean['fac_id']; ?>"
                                            class="btn btn-success btn-sm">Add Course</a>
                                        <form action="view-code.php" method="POST" class="d-inline">
                                            <button type="submit" name="faculty-course-delete"
                                                value="<?= $dean['c_name']; ?>"
