...
<head>
    ...
    <title>Dean Database table view</title>
</head>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>List of Registered Deans
                        </h4><br>
                        <!-- <a href="dean-register.php" class="btn btn-success btn-sm">Add New User</a> -->
                        <a href="dean-panel.php" class="btn btn-info btn-sm">Return</a>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="dean-view.php? id=<?= $dean['dean_id']; ?>"
