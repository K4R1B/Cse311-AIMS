...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM dean WHERE dean_id='$user_data'";
            ...
            <div class="row">
                ...
                <tr>
                  ...
                  <td>B+</td>
                            ...
                            <a href="dean-edit.php?id=<?= $user_data['dean_id']; ?>"
                                class="btn btn-success btn-sm">Edit</a>

                            <a href="dean-panel-dean-table.php" class="button">Return</a>
                        </div>
                    </div>
                </div>
            </div>
