...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (
        !empty($course) && !empty($dean_id) && !empty($fullname)
    ) {
        $query = "INSERT INTO faculty_course (c_name, fac_id, fac_name) VALUES ('$course', '$dean_id', '$fullname');";
        $query_run = mysqli_query($connect, $query);
                ...
                <div class="personal info">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="dean_id" value="<?= $dean['fac_id']; ?>" placeholder="101####"
                                disabled />
                        </div>
                    ...
                    <a href="admin-panel-faculty-course" class="btn btn-danger">Return</a>
                </div>
