...
<!-- <?php
        if (isset($_GET['id'])) {
            $user_id = $_GET['id'];
            $query = "SELECT * FROM faculty WHERE fac_id='$user_id'";
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (
        ...
        $sql = "SELECT * FROM faculty WHERE fac_id='$dean_id' limit 1";
        ...
        if ($ID === $dean_id) {
            $query = "INSERT INTO faculty_course (c_name, fac_id, fac_name) VALUES ('$course', '$ID', '$NAME');";
            $query_run = mysqli_query($connect, $query);

            header("Location:admin-panel-faculty-courses.php");
            die;
        } else {
            header("Location:faculty-data-course-register.php");
            die;
                ...
                <div class="personal info">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="dean_id" placeholder="201####" />
                        </div>
                    ...
                    <a href="admin-panel-faculty-courses.php" class="btn btn-danger">Return</a>
                </div>
