...
$user_data = check_login_faculty($connect);
?>

<?php
if (isset($_GET['id'])) {
    $user_data = mysqli_real_escape_string($connect, $_GET['id']);
    $query = "SELECT * FROM faculty WHERE fac_id='$user_data'";
            ...
            <div class="row">
                ...
                <tr>
                  ...
                  <td>B+</td>
                            ...
                            <!-- <a href="dean-edit.php?id=<?= $user_data['fac_id']; ?>"
                                class="btn btn-success btn-sm">Edit</a> -->

                            <a href="faculty-panel.php" class="button">Return</a>
                        </div>
                    </div>
                </div>
            </div>
