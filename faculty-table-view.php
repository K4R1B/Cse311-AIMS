            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>List of Registered Faculty
                        </h4><br>
                        <a href="faculty-register.php" class="btn btn-success btn-sm">Add New User</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="faculty-edit.php?id=<?= $dean['fac_id']; ?>"
                                            class="btn btn-success btn-sm">Edit</a>

                                        <form action="view-code.php" method="POST" class="d-inline">
                                            <button type="submit" name="faculty-delete" value="<?= $dean['fac_id']; ?>"
