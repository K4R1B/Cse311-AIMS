...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (
        ...
        $sql = "SELECT * FROM student WHERE std_id='$dean_id' limit 1";
        $result = mysqli_query($connect, $sql);

        $std_data = mysqli_fetch_assoc($result);
        $NAME = $std_data['full_name'];
        $ID = $std_data['std_id'];


        if ($ID === $dean_id) {
            $query = "INSERT INTO student_course (c_name, std_id, std_name) VALUES ('$course', '$ID', '$NAME');";
            $query_run = mysqli_query($connect, $query);

            header("Location:admin-panel-student-courses.php");
            die;
        } else {
            header("Location:student-data-course-register.php");
            die;
                ...
                <div class="personal info">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="dean_id" placeholder="101####" />
                        </div>
                        <!-- 
                        <div class="input-field">
                            <label for="Full Name">Full Name</label>
                            <input type="text" name="fullname" disabled value="<? $std_data['full_name'] ?>" placeholder="Enter Full Name" />
                        </div> -->
                        ...
                        <!-- <div class="input-field">
                            ...
                            <input type="text" value="<?= $dean['stat']; ?>" name="stat"
                                placeholder="Regular/Probation/Suspended" disabled />
                        </div>
                    ...
                    <a href="admin-panel-student-courses.php" class="btn btn-danger">Return</a>
                </div>
