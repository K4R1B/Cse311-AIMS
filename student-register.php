...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (
        ...
        && !empty($cgpa) && !empty($credit)
    ) {

        $query = "INSERT INTO student (std_id, full_name, dob, gender, phone, email, dept, sdate, stat, nid_pass, address, salary, passkey, cgpa, credit) 
        VALUES('$id','$fullname','$dob','$gender','$number','$email','$dept','$jod','$stat'
        ,'$nid','$address','$salary','$pass','$cgpa','$credit')";
                ...
                <div class="personal info">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="id" placeholder="301####" />
                        </div>
                    ...
                    <a href="student-table-view.php" class="btn btn-danger">Return</a>
                </div>
